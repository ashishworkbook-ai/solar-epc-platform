...
async function main() {
  ...
  for (let i = 0; i < projectsData.length; i++) {
    ...
    await prisma.stageHistory.create({
      data: {
        ...
        tenantId: tenant.id,
        stageId: p.currentStage,
        stageName: p.currentStageName,
  ...
  console.log("Login: owner@sunpowerepc.com / password123");
}
